...
exports.closeAlert = exports.alert = void 0;
var modal = document.querySelector(".modal");
var overlay = document.querySelector(".overlay");
var btnCloseModal = document.querySelector(".close-modal");
var cnt = document.querySelector("#feedback-nav");
...
var signup = exports.signup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
    var username, email, password, confirmPassword, URL, cred, res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          confirmPassword = document.querySelector("#confrim-password").value;
          URL = "/apiVerse/v1/users/signup";
          cred = {
            name: username,
            email: email,
            password: password,
          ...
          _context.next = 10;
          return _axios.default.post(URL, cred);
        case 10:
          res = _context.sent;
        ...
        case 14:
          ...
          message.textContent = _context.t0.response.data.message;
          (0, _alert.alert)();
        case 18:
        case "end":
...
var login = exports.login = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
    var email, password, URL, cred, res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
...
},{"./alert":"alert.js","axios":"../../node_modules/axios/index.js"}],"feedback.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.reviews = exports.feedback = void 0;
var _alert = require("./alert");
var _axios = _interopRequireDefault(require("axios"));
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var message = document.querySelector(".modal-text");
var modalMessage = document.querySelector(".modal-heading");
var cnt = document.querySelector("#feedback-nav");
var rev = document.querySelector(".reviews-cnt");
var feedback = exports.feedback = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
    var name, user_review, URL, cred, res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          ...
          user_review = document.querySelector("#feedback").value;
          URL = "/apiVerse/v1/reviews";
          cred = {
            name: name,
  ...
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          URL = "/apiVerse/v1/reviews?page=1&limit=4?sort=createdAt";
          _context2.next = 4;
        ...
        case 4:
          ...
          value.forEach(function (arr) {
            var reviewsCnt = "  <div class=\"review first\">\n            <p class=\"review-text\">".concat(arr.user_review, "              \n            </p>\n            <span class=\"review-text name\">").concat(arr.name, "</span>\n          </div>");
...
// reviews();
},{"./alert":"alert.js","axios":"../../node_modules/axios/index.js"}],"apiScript.js":[function(require,module,exports) {
"use strict";
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var cardCnt = document.querySelector(".card-cnt");
var cards = exports.cards = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          value = res.data.message;
          value.forEach(function (arr) {
            var reviewsCnt = " <div class=\"card-inner-cnt\">\n            <img src=\"/img/api/".concat(arr.image, "\" class=\"img-api\" />\n            <div class=\"content\">\n              <h3 class=\"heading\">").concat(arr.name, "</h3>\n              <p class=\"desc\">\n               ").concat(arr.title, "\n              </p>\n              <div class=\"btn-cnt\">\n                <a href=\"/apiVerse/apiPage?value=").concat(arr._id, "\" class=\"imp-btn\">Use it</a>\n              </div>\n            </div>\n          </div>");
...
},{"axios":"../../node_modules/axios/index.js"}],"apiPageScript.js":[function(require,module,exports) {
"use strict";
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var section = document.querySelector(".section-cnt");
var pageData = exports.pageData = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var val, arr, id, URL, res, value, desc, result, html, copy;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
...
},{"axios":"../../node_modules/axios/index.js"}],"profileScript.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.profileFun = void 0;
var _alert = require("./alert");
var _axios = _interopRequireDefault(require("axios"));
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
var saveUserNameFun = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
    var userNewName, cred, URL, res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          e.preventDefault();
          userNewName = text.value === " " ? data.name : text.value;
          cred = {
            name: userNewName
          };
          URL = "/apiVerse/v1/users/";
          _context.next = 7;
          return _axios.default.patch(URL, cred);
        case 7:
          res = _context.sent;
          if (res.data.status === "success") {
  ...
  return function saveUserNameFun(_x) {
    return _ref.apply(this, arguments);
  };
}();
var changePasswordFun = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e) {
    var passwordOld, newPassword, pass, npass, cred, URL, res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          ...
          npass = newPassword.value;
          cred = {
            password: pass,
            newPassword: npass
          };
          URL = "/apiVerse/v1/users/updatePassword";
          _context2.next = 10;
          return _axios.default.patch(URL, cred);
        case 10:
          res = _context2.sent;
        ...
        case 15:
          _context2.prev = 15;
          _context2.t0 = _context2["catch"](0);
          message.textContent = _context2.t0.response.data.message;
          (0, _alert.alert)();
        case 19:
        case "end":
          return _context2.stop();
  ...
  return function changePasswordFun(_x2) {
    return _ref2.apply(this, arguments);
  };
}();
var logoutFun = /*#__PURE__*/function () {
  ...
  return function logoutFun(_x3) {
    return _ref3.apply(this, arguments);
  };
}();
var profileFun = exports.profileFun = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(e) {
    var name, email, _text, saveUserName, changePassword, logout, URL, res, _data;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          _text = document.querySelector("#text");
          saveUserName = document.querySelector("#save-user-name");
          changePassword = document.querySelector("#change-password");
          logout = document.querySelector("#logout");
          URL = "/apiVerse/v1/users/profile";
          _context4.next = 10;
          return _axios.default.get(URL);
        case 10:
          res = _context4.sent;
  ...
  return function profileFun(_x4) {
    return _ref4.apply(this, arguments);
  };
}();
},{"./alert":"alert.js","axios":"../../node_modules/axios/index.js"}],"forgotScript.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.forgotPasswordFunction = void 0;
var _alert = require("./alert");
var _axios = _interopRequireDefault(require("axios"));
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
var forgot = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
    var message, heading, email, URL, cred, res, _message;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          e.preventDefault();
          message = document.querySelector(".model-text");
          heading = document.querySelector(".model-heading");
          email = document.querySelector("#email").value;
          URL = "/apiVerse/v1/users/forgotPassword";
          cred = {
            email: email
          };
          _context.next = 9;
        ...
        case 13:
          _context.prev = 13;
          _context.t0 = _context["catch"](0);
          _message = document.querySelector(".model-text");
          _message.textContent = _context.t0.response.data.message;
          (0, _alert.alert)();
        case 18:
        case "end":
          return _context.stop();
...
var forgotPassword = document.querySelector("#send-email");
var forgotPasswordFunction = exports.forgotPasswordFunction = function forgotPasswordFunction() {
  forgotPassword.addEventListener("click", forgot);
};
},{"./alert":"alert.js","axios":"../../node_modules/axios/index.js"}],"resetScript.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.resetPasswordFunction = void 0;
var _alert = require("./alert");
var _axios = _interopRequireDefault(require("axios"));
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
var reset = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
    var newPass, confirm, message, heading, link, token, URL, cred, res, _message;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          ...
          message = document.querySelector(".model-text");
          heading = document.querySelector(".model-heading");
          link = window.location.href.split("resetPassword/");
          console.log(newPass.value, confirm.value);
          token = link[1];
          URL = "/apiVerse/v1/users/resetPassword/".concat(token);
          cred = {
...
var resetPasswordFunction = exports.resetPasswordFunction = function resetPasswordFunction() {
...
var _apiScript = require("./apiScript");
var _apiPageScript = require("./apiPageScript");
var _profileScript = require("./profileScript");
var _forgotScript = require("./forgotScript");
var _resetScript = require("./resetScript");
var signBtn = document.querySelector("#sign-btn");
var loginBtn = document.querySelector("#login-btn");
var modal = document.querySelector(".modal");
var overlay = document.querySelector(".overlay");
var btnCloseModal = document.querySelector(".close-modal");
var feed = document.querySelector(".cta-btn");
var profile = document.querySelector("#profile_");
(0, _feedback.reviews)();
if (window.location.href.includes("apiVerse/api")) {
  (0, _apiScript.cards)();
}
if (window.location.href.includes("apiVerse/apiPage")) {
  (0, _apiPageScript.pageData)();
}
if (window.location.href.includes("apiVerse/profile")) {
  (0, _profileScript.profileFun)();
}
if (window.location.href.includes("apiVerse/forgotPassword")) {
  (0, _forgotScript.forgotPasswordFunction)();
}
if (window.location.href.includes("apiVerse/resetPassword/")) {
  (0, _resetScript.resetPasswordFunction)();
}
if (btnCloseModal) {
  btnCloseModal.addEventListener("click", _alert.closeAlert);
  overlay.addEventListener("click", _alert.closeAlert);
}
...
if (signBtn) {
  signBtn.addEventListener("click", _signup.signup);
}
if (loginBtn) {
  loginBtn.addEventListener("click", _login.login);
}
if (feed) {
  feed.addEventListener("click", _feedback.feedback);
}
},{"./signup":"signup.js","./login":"login.js","./alert":"alert.js","./feedback":"feedback.js","./apiScript":"apiScript.js","./apiPageScript":"apiPageScript.js","./profileScript":"profileScript.js","./forgotScript":"forgotScript.js","./resetScript":"resetScript.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
